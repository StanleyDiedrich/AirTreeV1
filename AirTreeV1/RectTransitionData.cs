            ...
            else if (SystemType == DuctSystemType.ExhaustAir && relA < 1)
            {
                Values = new double[,]
                {
                   /* {0,0,10,15,20,30,40,60,90,120,150,180 },
                    ...
                    {100000,0.9,0.05,0.05,0.05,0.05,0.05,0.06,0.12,0.18,0.24,0.26 },*/ 
                   // поправил соотношение площадей, потому что на тестах 0.66, а таблица ограничена 0.5
                    ...
                    {0.9,0.05,0.05,0.05,0.05,0.05,0.06,0.12,0.18,0.24,0.26 },
                };
            }
            ...
            else if (SystemType == DuctSystemType.SupplyAir && relA < 1)
            {
                Values = new double[,]
               {
                  /* {0,0,10,15,20,30,40,60,90,120,150,180 },
                    ...
                    {100000,0.17,0.05,0.04,0.04,0.04,0.04,0.07,0.18,0.28,0.36,0.42 },
                    {100000,0.25,0.05,0.04,0.04,0.04,0.05,0.07,0.17,0.27,0.35,0.41 },
                    {100000,0.9,0.05,0.05,0.05,0.05,0.05,0.06,0.12,0.18,0.24,0.26 },*/ // поправил соотношение площадей, потому что на тестах 0.66, а таблица ограничена 0.5
